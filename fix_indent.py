...
nb_file = 'notebooks/harsh_offline_pipeline.ipynb'
with open(nb_file) as f:
    nb = json.load(f)

source = nb['cells'][5]['source']
for i, line in enumerate(source):
    if line.startswith('    for i in range(0, len(texts_to_embed), CHUNK_SIZE):'):
        pass # this is the line we added
    elif i >= 55 and i <= 72: # Adjusting indentation
        # We need to add 4 spaces to the lines inside the for loop
        pass

# Actually, it's easier to just rewrite Cell 5 cleanly.
