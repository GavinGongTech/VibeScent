"""Vendored from Qwen/Qwen3-VL-Embedding-8B HuggingFace model repo.

Source: https://huggingface.co/Qwen/Qwen3-VL-Embedding-8B/blob/main/scripts/qwen3_vl_embedding.py
Requires: transformers>=4.57.0, qwen-vl-utils>=0.0.14, torch>=2.0.0, accelerate
"""
